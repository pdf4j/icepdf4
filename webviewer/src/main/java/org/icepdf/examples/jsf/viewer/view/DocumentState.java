...
public class DocumentState implements Serializable {
    ...
    public void openDocument() throws PDFException, IOException, PDFSecurityException {
        ...
        synchronized (documentLock) {
            ...
            if (outlines != null && outlines.getRootOutlineItem() != null) {
                ...
                DefaultMutableTreeNode rootItem = new OutlineItemTreeNode(document.getPageTree(),
     ...
     */
    public class PDFResource extends javax.faces.application.Resource implements Serializable {
